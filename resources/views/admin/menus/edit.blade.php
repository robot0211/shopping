                        ...
                        <div class="card-body">
                            <form action="{{ route('menus.update', ['id' => $menu->id]) }}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" value="{{ $menu->name }}" class="form-control" placeholder="Nhập tên menu">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="url" value="{{ $menu->url }}" class="form-control" placeholder="Nhập url">
                                </div>
                                <div class="d-grid">
