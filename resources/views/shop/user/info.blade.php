...
<link href="{{ asset('shops/account/font-awesome.min.css') }}" rel="stylesheet">
<link rel="stylesheet" href="{{ asset('shops/account/account.css') }}">
@endsection
        ...
        <div class="profile-nav col-md-3">
            <div class="panel">
                <div class="user-heading round">
                    ...
                    <h1>{{ Auth::guard('cus')->user()->name }}</h1>
        ...
        <div class="profile-info col-md-9">
            ...
            <div class="panel">
                <div class="bio-graph-heading">
                    <h4>"Phong cách là cách để nói lên bạn là ai mà không cần phải nói một lời." - Rachel Zoe</h3>
                </div>
                <div class="panel-body bio-graph-info">
                    <h1>Bio Graph</h1>
                    <div class="row">
                        <div class="bio-row">
                            <p><span>Name </span>: {{ Auth::guard('cus')->user()->name }}</p>
                        </div>
    
                        <div class="bio-row">
                            <p><span>Address </span>: {{ Auth::guard('cus')->user()->address }}</p>
                        </div>
                        <div class="bio-row">
                            <p><span>Birthday</span>: 13 July 2003</p>
                        </div>
                        <div class="bio-row">
                            <p><span>Occupation </span>: UI Designer</p>
                        </div>
                        <div class="bio-row">
                            <p><span>Email </span>: {{ Auth::guard('cus')->user()->email }}</p>
                        </div>
                        <div class="bio-row">
                            <p><span>Phone </span>: {{ Auth::guard('cus')->user()->phone }}</p>
                        </div>
                    </div>
                </div>
            </div>
